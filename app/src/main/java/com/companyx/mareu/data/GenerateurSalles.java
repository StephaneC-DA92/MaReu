...
public abstract class GenerateurSalles {
    ...
    public static List<Salle> SALLES_LAMZONE = Arrays.asList(
            ...
            new Salle("Luigi","France",10, Salle.Couleur.Vert, Salle.Icone.Vert),
            new Salle("Apple","France",3, Salle.Couleur.Orange, Salle.Icone.Orange),
            new Salle("Pomme","Etats-Unis",15, Salle.Couleur.Orange, Salle.Icone.Orange),
            ...
            new Salle("Toto","Etats-Unis",100, Salle.Couleur.Vert, Salle.Icone.Vert),
            new Salle("Room1","Etats-Unis",3, Salle.Couleur.Vert, Salle.Icone.Vert),
            new Salle("DasRoom","Allemagne",12, Salle.Couleur.Orange, Salle.Icone.Orange)
            );
}
